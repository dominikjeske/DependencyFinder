...
namespace FastSearchLibrary
{
    ...
    public class FileSearcher
    {
        ...
        /// <exception cref="ArgumentException"></exception>
        /// <exception cref="ArgumentNullException"></exception>
        public FileSearcher(string folder, string pattern, CancellationToken token, ExecuteHandlers handlerOption, bool suppressOperationCanceledException)
        {
            CheckFolder(folder);

            CheckPattern(pattern);

            searcher = new FileCancellationPatternSearcher(folder, pattern, token, handlerOption, suppressOperationCanceledException);
        }
        ...
        /// <exception cref="ArgumentException"></exception>
        /// <exception cref="ArgumentNullException"></exception>
        public FileSearcher(string folder, string pattern, CancellationToken token, ExecuteHandlers handlerOption)
            : this(folder, pattern, token, handlerOption, true)
        {
        }
        ...
        /// <exception cref="ArgumentException"></exception>
        /// <exception cref="ArgumentNullException"></exception>
        public FileSearcher(string folder, string pattern, CancellationToken token) 
            : this(folder, pattern, token, ExecuteHandlers.InCurrentTask, true)
        {
        }
        ...
        /// <exception cref="ArgumentException"></exception>
        /// <exception cref="ArgumentNullException"></exception>
        public FileSearcher(string folder, CancellationToken token) 
            : this(folder, "*", token, ExecuteHandlers.InCurrentTask, true)
        {
        }
        ...
        /// <exception cref="ArgumentException"></exception>
        /// <exception cref="ArgumentNullException"></exception>
        public FileSearcher(string folder, Func<FileInfo, bool> isValid, CancellationToken token, ExecuteHandlers handlerOption, bool suppressOperationCanceledException)
        {
            CheckFolder(folder);
            ...
            searcher = new FileCancellationDelegateSearcher(folder, isValid, token, handlerOption, suppressOperationCanceledException);
            this.token = token;
        }
        ...
        /// <exception cref="ArgumentException"></exception>
        /// <exception cref="ArgumentNullException"></exception>
        public FileSearcher(string folder, Func<FileInfo, bool> isValid, CancellationToken token, ExecuteHandlers handlerOption)
            : this(folder, isValid, token, handlerOption, true)
        { 
        }
        ...
        /// <exception cref="ArgumentException"></exception>
        /// <exception cref="ArgumentNullException"></exception>
        public FileSearcher(string folder, Func<FileInfo, bool> isValid, CancellationToken token)
            : this(folder, isValid, token, ExecuteHandlers.InCurrentTask, true)
        {
        }
